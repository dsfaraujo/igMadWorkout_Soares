...
class ViewController: UIViewController, WCSessionDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    //initialisateur de l'user defaults
    var exerciseAccount: UserDefaults = UserDefaults.standard
    var session: WCSession!
    //Dictionaire pour les exercices
    ...
    // ============================
    //load la view de ViewController
    ...
    //--------------------------------------------------
    //fonctions de connexion avec apple watch
    @available(iOS 9.3, *)
    ...
    //button sauvegarde les exercices dans le clipboard
    ...
    // ============================
    //boutton que envoye les messages pour le apple watch
    ...
    // ============================
    //function pour initialiser la session du apple watch
    func session(_ session: WCSession, didReceiveMessage message: [String : Any], replyHandler: @escaping ([String : Any]) -> Void) {
     ...
     // ============================
    //function de envoyer le message avec le watch
    ...
    //fonction que garde les activités ajoutées dans le systeme
    // ============================
    ...
    // ============================
    //function que fait la verification des userDefaults
    ...
    //function que initialise du pickerview
    func numberOfComponents(in pickerView: UIPickerView) -> Int
    {
        return 1
    }
    // ============================
    //function que rampli le picker view
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView
    {
        ...
        var tempStr = ""
        //ramplissage de chaque exercice dans le pickerview
    ...
    // ============================
    //function que compte le nombre d'elements que le pickerview contient
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int
    {
        return self.exerciseAccountability.count;
    }
    // ============================
    //function que load pickerview
    ...
    // ============================
    //function que mettre a jour le datePicker
    ...
    // ============================
    //bouton pour cacher le keyboard
    @IBAction func hideKeyboard(_ sender: UIButton)
    {
        self.view.endEditing(true)
    }
    // ============================
    //fonction pour ajouter l'exercice choisit
    ...
    // ============================
    //fonction pour valider l'exercice
    ...
    // ============================
    //fonction que envoye un alert avec les exercices choisits
    ...
    // ============================
    //fonction que montre les exercices mises dans la base de données
...
//formatation de la date pour la base de données
extension Date
{
